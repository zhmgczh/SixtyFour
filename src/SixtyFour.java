...
{
    private static final String[]signs={"坤","剝","比","觀","豫","晉","萃","否","謙","艮","蹇","漸","小過","旅","咸","遁","師","蒙","坎","渙","解","未濟","困","訟","升","蠱","井","巽","恒","鼎","大過","姤","復","頤","屯","益","震","噬嗑","隨","無妄","明夷","賁","既濟","家人","豐","離","革","同人","臨","損","節","中孚","歸妹","睽","兌","履","泰","大畜","需","小畜","大壯","大有","夬","乾"};
